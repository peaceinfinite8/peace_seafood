...
try {
    ...
    $svc = new PenjualanService();
    $idNota = $svc->createNota([
        'items' => [['id_produk' => $idProduk, 'qty' => 1, 'harga_jual' => 15000]],
        'jenis_pembayaran' => 'cash'
    ], $idUser, $idGudang);

    $finalOk = $svc->finalizeNota($idNota, $idGudang, false);

    echo json_encode(['success' => true, 'nota_id' => $idNota, 'finalized' => $finalOk]) . PHP_EOL;
} catch (Throwable $e) {
