...
<div x-data="penjualanPage()" x-init="init()">
    ...
    <div class="no-print">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="${window.APP_BASE_URL}/penjualan/create" class="btn btn-primary"
        ...
        <!-- Filter -->
        <div
            class="mb-6 rounded-2xl border border-[color:var(--border-color)] bg-[color:var(--bg-light)] p-4 shadow-sm">
            <div class="flex flex-wrap gap-3">
                <input type="text" x-model="search" placeholder="Cari no nota / pembeli..."
                    class="w-full min-w-48 flex-1 rounded-lg border border-[color:var(--border-color)] bg-[color:var(--bg-light)] px-3 py-2 text-sm text-[color:var(--text-primary)] outline-none transition focus:border-[color:var(--color-primary)] focus:ring-2 focus:ring-[color:var(--color-primary-light)]">
                <input type="text" id="filter-dari" placeholder="Tanggal dari..."
                    ...
                    readonly>
                <input type="text" id="filter-sampai" placeholder="Tanggal sampai..."
                    class="w-auto rounded-lg border border-[color:var(--border-color)] bg-[color:var(--bg-light)] px-3 py-2 text-sm text-[color:var(--text-primary)] outline-none transition focus:border-[color:var(--color-primary)] focus:ring-2 focus:ring-[color:var(--color-primary-light)]"
                    readonly>
