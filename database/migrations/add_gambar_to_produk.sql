-- ============================================================
-- Migration: Tambah kolom gambar ke tabel produk
-- ============================================================

USE `peace_seafood`;

ALTER TABLE `produk`
  ADD COLUMN `gambar` VARCHAR(100) NULL DEFAULT NULL
  AFTER `deskripsi`;

-- Update gambar untuk produk yang sudah ada berdasarkan nama
