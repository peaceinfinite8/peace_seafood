            ...
            <table class="table">
                ...
                <tbody>
                    <template x-if="filteredList.length === 0">
                        <tr><td colspan="7" class="text-center py-8" style="color:var(--text-secondary)">Tidak ada data</td></tr>
                    </template>
    ...
    <div class="modal-overlay" x-show="showBayarModal" @click.self="showBayarModal = false" x-cloak>
        <div class="modal-box">
            ...
            <div class="form-group">
                ...
                <input type="number" x-model="bayarForm.nominal_bayar" class="form-input" :max="selectedHp?.sisa_hutang" min="1000" step="1000">
            </div>
            <div class="form-group">
