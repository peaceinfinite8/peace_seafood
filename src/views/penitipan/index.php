...
<div x-data="penitipanPage()" x-init="init()">
    ...
    <div class="card p-4 mb-6">
        <div class="flex flex-wrap gap-3">
            <input type="text" x-model="search" placeholder="Cari supplier / produk..." class="form-input flex-1 min-w-48">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <template x-for="t in filtered" :key="t.id">
                        <tr>
                            <td><span class="font-medium text-sm" x-text="t.nama_supplier || t.nama_pembeli || '-'"></span></td>
            ...
            <template x-if="detail">
                <div class="grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div class="p-3 rounded-lg" style="background:var(--bg-gray)">
                        ...
                        <p class="font-semibold text-green-600" x-text="parseFloat(detail.jumlah_terjual||0).toFixed(1) + ' kg'"></p>
                    </div>
                    <div class="p-3 rounded-lg" style="background:var(--bg-gray)">
                        <p class="text-xs mb-1" style="color:var(--text-secondary)">Harga Titip</p>
                        <p class="font-semibold" x-text="'Rp ' + parseFloat(detail.harga_titip||0).toLocaleString('id-ID')"></p>
                    </div>
                    <div class="p-3 rounded-lg" style="background:var(--bg-gray)">
        ...
        <div class="modal-box">
            ...
            <template x-if="selectedTitipan">
                <div class="mb-4 p-3 rounded-lg text-sm" style="background:var(--bg-gray)">
                    ...
                    Sisa: <strong x-text="(parseFloat(selectedTitipan.jumlah||0)-parseFloat(selectedTitipan.jumlah_terjual||0)).toFixed(1)+' kg'"></strong>
                </div>
            </template>
            <form @submit.prevent="submitJual()">
                <div class="form-group">
                    <label class="form-label">Jumlah Terjual (kg) *</label>
                    <input type="number" x-model="jualForm.jumlah_terjual" step="0.01" min="0.01" class="form-input" required>
                </div>
                <div class="form-group">
                    ...
                    <p class="text-xs mt-1" style="color:var(--text-secondary)">
                        Total: <strong x-text="'Rp '+(jualForm.jumlah_terjual*jualForm.harga_jual||0).toLocaleString('id-ID')"></strong>
                    </p>
                </div>
                <div class="form-group">
