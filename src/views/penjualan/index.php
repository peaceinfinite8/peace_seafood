    ...
    <div class="no-print">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6" x-show="!loading" x-cloak>
            ...
            <div class="stat-card">
                ...
                <p class="text-2xl font-bold text-yellow-500" x-text="notaList.filter(n=>n.status==='draft').length">
                </p>
            </div>
            <div class="stat-card">
...
<?php $scripts = '<script src="/peace_seafood/inline-assets/js/penjualan/index.js"></script>'; ?>