    ...
    <div class="max-w-2xl">
        <form @submit.prevent="submit()" class="card p-6 space-y-5">
                ...
                <div class="grid grid-cols-2 gap-3">
                    <label class="cursor-pointer">
                        ...
                        <div class="p-4 rounded-xl border-2 text-center transition-all"
                            ...
                            <p class="font-semibold text-sm" :style="form.tipe==='stok' ? 'color:#2563eb' : ''">Retur
                                Stok</p>
                    ...
                    <label class="cursor-pointer" x-show="['super_admin','admin'].includes(user.role)">
                        ...
                        <div class="p-4 rounded-xl border-2 text-center transition-all"
                            ...
                            <p class="font-semibold text-sm" :style="form.tipe==='piutang' ? 'color:#2563eb' : ''">Retur
                                Piutang</p>
                ...
                <div class="space-y-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" x-model="form.qty" step="0.01" min="0.01"
                            :max="selectedProduk?.stok_qty || 99999" class="form-input" placeholder="0.00" required>
                        <p class="text-xs mt-1" style="color:var(--text-secondary)" x-show="selectedProduk">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file" x-ref="fotoInput" accept="image/*" class="form-input"
            ...
            <template x-if="form.tipe === 'piutang'">
                <div class="space-y-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" x-model="form.nominal" step="1000" min="1" class="form-input"
            ...
            <div class="p-4 rounded-lg text-sm border-l-4 border-yellow-400" style="background:var(--bg-gray)">
                ...
                <p style="color:var(--text-secondary)">Retur akan berstatus <strong>PENDING</strong> dan memerlukan
                    persetujuan dari <strong>Bos</strong> sebelum inventory/hutang diupdate.</p>
            </div>
...
<?php $scripts = '<script src="/peace_seafood/inline-assets/js/retur/create.js"></script>'; ?>